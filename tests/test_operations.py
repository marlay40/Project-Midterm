...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "b_greater_than_a": {"a": "3", "b": "10", "expected": "3"},
        "negative_a": {"a": "-10", "b": "3", "expected": "-1"},
        "negative_b": {"a": "10", "b": "-3", "expected": "1"},
        "both_negative": {"a": "-10", "b": "-3", "expected": "-1"},
        "decimal_modulus": {"a": "5.5", "b": "2", "expected": "1.5"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "10",
...
class TestIntDivide(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "b_greater_than_a": {"a": "3", "b": "10", "expected": "0"},
        "negative_a": {"a": "-10", "b": "3", "expected": "-3"},
        "negative_b": {"a": "10", "b": "-3", "expected": "-3"},
        "both_negative": {"a": "-10", "b": "-3", "expected": "3"},
        "decimal_division": {"a": "5.5", "b": "2", "expected": "2"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "10",
...
class TestPercent(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "a_greater_than_b": {"a": "250", "b": "200", "expected": "125"},
        "decimal_values": {"a": "2.5", "b": "5", "expected": "50"},
        "negative_a": {"a": "-50", "b": "200", "expected": "-25"},
        "negative_b": {"a": "50", "b": "-200", "expected": "-25"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "50",
