...
def test_percent():
    calc = Calculation(operation="Percent", operand1=Decimal("5"), operand2=Decimal("20"))
    assert calc.result == Decimal("25")


def test_absdifference():
    calc = Calculation(operation="AbsDifference", operand1=Decimal("-6"), operand2=Decimal("4"))
